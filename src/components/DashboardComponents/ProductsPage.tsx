...
//     (p) => p.status?.toLowerCase() === "low stock" || p.status?.toLowerCase() === "out of stock"
//   ).length || 0
...
//             </CardHeader>
//             <CardContent>
//               {/* You can calculate sum here if needed */}
...
//                         variant="secondary"
//                       >
//                         {product.inventory === 0 ? "Out of Stock" : product.status || "Active"}
//                       </Badge>
//                     </TableCell>
//                     <TableCell className="text-right">
//                       <div className="flex justify-end gap-2">
